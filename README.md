...
- Variables sensibles deben definirse con placeholders `${VAR_NAME}` o `${VAR_NAME:default}` y resolverse desde `.env` o secretos externos.
...
- `sgivu-ml` no usa Spring Cloud Config para su configuración de runtime; se configura vía variables de entorno en su servicio FastAPI.
